...
const coursesData: CourseTrack[] = [
  {
    ...
    detailUrl: 'https://megazone-ai-ms-01.vercel.app'
  },
  {
    id: 'architect',
    trackCode: 'TRACK 02',
    ...
    detailUrl: 'https://megazone-ai-ms-02.vercel.app'
  },
  {
    id: 'security',
    trackCode: 'TRACK 03',
    ...
    detailUrl: 'https://megazone-ai-ms-03.vercel.app'
  },
  {
    id: 'data',
    trackCode: 'TRACK 04',
    ...
    detailUrl: 'https://megazone-ai-ms-04.vercel.app'
  }
];
...
export default function App() {
  ...
  const handlePhoneClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    if (!isMobile) {
      e.preventDefault();
      window.open('https://naver.me/FNIvuDol', '_blank', 'noopener,noreferrer');
    }
  };
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append('_form_id', 'ca2310b9e38c197dfb7ef162b557d80a');
      ...
      <header className="header" id="header">
        <div className="header-inner">
          <div className="header-left">
            <a href="https://megazone-ai-ms.vercel.app" className="logo-wrap" id="headerLogoLink">
              <img
            ...
            <nav className="gnb-nav">
              <a href="https://megazone-ai-ms-01.vercel.app">AI 에이전트</a>
              <a href="https://megazone-ai-ms-02.vercel.app">AI 아키텍트</a>
              <a href="https://megazone-ai-ms-03.vercel.app">AI 보안</a>
              <a href="https://megazone-ai-ms-04.vercel.app">AI 데이터</a>
              <a href="#faq">FAQ</a>
            </nav>
          </div>
          <div className="header-right">
            <a
              href="https://naver.me/FNIvuDol"
              target="_blank"
        ...
        <div className={`mobile-drawer ${mobileMenuOpen ? 'open' : ''}`} id="mobileDrawer">
          <a href="https://megazone-ai-ms-01.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 에이전트</a>
          <a href="https://megazone-ai-ms-02.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 아키텍트</a>
          <a href="https://megazone-ai-ms-03.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 보안</a>
          <a href="https://megazone-ai-ms-04.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 데이터</a>
              ...
              <div className="apply-yellow-contact">
                ...
                >
                  ...
                  <div className="apply-contact-text">
                    ...
                    <span className="apply-contact-value phone-number">1644-7157</span>
                  </div>
                </a>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div>
            ...
            <p>MEGAZONE CLOUD x MBC아카데미 컴퓨터교육센터 | 홈페이지 운영 관리 담당자 : 김민석</p>
            <p>AI Campus · K-Digital Training | 교육문의 : <a href="tel:1644-7157" className="footer-tel-link" onClick={handlePhoneClick}>1644-7157</a></p>
